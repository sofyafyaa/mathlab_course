...
% 4) Provide the evidence that results matrix and legacy matrix is the sa +
...
Time_legacy_code_average = Time_legacy_code_average / 50;
Time_Optimised_code_average = Time_Optimised_code_average / 50;
...
% Function "New_instruction" works 3-4 times 
% faster than fuction "Old_inctructon". 
% Matlab has several approaches to accessing 
% array elements (by position & logical indexing)
% We can make conclusion that accessing array elements
% by logical indexing is more faster than by position.
