...
for itter = 735 : Res_correlation_sz
    ...
    elseif (Res_correlation(itter) == 1) && (Res_correlation(itter - 1) ~= 1)
        Number_Of_Frame = Number_Of_Frame + 1;
        Start_Of_Frame_Positions(Number_Of_Frame) = itter + 1;
    end
end

Size_Of_Data = Start_Of_Frame_Positions(3) - Start_Of_Frame_Positions(2) - length(Header);
